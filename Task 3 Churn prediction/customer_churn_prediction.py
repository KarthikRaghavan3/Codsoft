...
Original file is located at
    https://colab.research.google.com/drive/1Msg6EwAYPovGVZ9kVCZAfe-tXVbeIiOm
"""
...
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/kaggle_dataset/customer_churn/Churn_Modelling.csv')
